...
export default function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex flex-col w-full items-center justify-center overflow-hidden rounded-lg dark:bg-black  bg-background p-10 md:shadow-xl"
      ref={containerRef}
    >
      <div className="my-4">
...
const Icons = {
  ...
  openai: (props: IconProps) => (
    <div className="text-black font-bold text-2xl antialiased">
      skills
    </div>
  ),
