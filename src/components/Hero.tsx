...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative flex h-screen w-full items-center justify-center  bg-background bg-gradient-to-r from-gray-200 dark:from-black via-white dark:via-gray-900 to-gray-200 dark:to-black">
