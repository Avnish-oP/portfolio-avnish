...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative flex h-screen w-full items-center justify-center overflow-hidden bg-background bg-gradient-to-r from-gray-200 dark:from-black  via-white dark:via-gray-900 to-gray-200   dark:to-black">
      <svg
        ref={svgRef}
        width="100%"
        height="100%"
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen w-full px-4 lg:px-10">
        <div className="sm:flex md:flex min-h-[70vh] lg:min-h-screen w-full justify-between items-center p-4">
          <div className="left mb-16 mt-20 lg:mt-0 basis-[50vw] flex flex-col justify-center items-center gap-10 lg:gap-6">
            <h1 className="text-4xl mt-12 lg:mt-0 md:text-5xl lg:text-6xl font-bold antialiased dark:text-white">
              Hello, I{"'"}m Avnish
            </h1>
            <div className="mt-4 text-3xl dark:text-white">
            ...
            <Link
              href={"/contact"}
              className="mt-8 inline-block bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg transition-colors duration-300"
            >
              Contact Me
            </Link>
          </div>
