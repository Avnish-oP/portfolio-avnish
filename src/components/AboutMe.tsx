  ...
  const FloatingIcon = ({ icon, color }) => {
    ...
    return (
      <mesh ref={ref} position={position}>
        <Html center className="text-6xl" style={{ color }}>
    ...
    <div className="flex flex-col md:flex-row h-screen dark:text-white justify-around items-center">
      <div className="md:w-1/2 flex flex-col justify-center items-center p-8">
        <div className="text-center ">
          ...
          <Link href="/contact">
            <button className="mx-auto px-6 py-2 bg-blue-600 text-white rounded-lg font-medium hover:font-bold flex items-center transform hover:-translate-y-1 transition duration-400">
              Contact Me
              <svg
